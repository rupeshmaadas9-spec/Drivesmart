...
Key Outcome
A scalable system that enables rental price prediction, deal evaluation, and data-driven booking decisions.


Future Scope
Real-time data pipelines, multi-city and global expansion, advanced model optimization, and interactive dashboards.
